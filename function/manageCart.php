...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        if(isset($_POST['order'])) {
            ...
            $sql1 = "INSERT INTO `order-manager`(`Fullname`, `Email`, `Phonenumber`, `Address`, `Total_Price`, `Status`) 
                    VALUES ('$_POST[fullname]','$_POST[email]','$_POST[phonenumber]','$_POST[address]', '$_POST[total]', 'Processing')";
