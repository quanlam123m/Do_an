...
<body>
    ...
    <div class="header">
        <h1 class="heading"> Carousel Management </h1>
    </div>

    <div class="icon add">
        <a id="addCarousel" href="#" class="btn">Add Carousel</a>
    </div>
                    ...
                    if ($count > 0) {
                        while($rows = mysqli_fetch_assoc($res)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $name; ?></td>
                                <td>
                                        <img src="<?php echo $url; ?>images/carousel/<?php echo $img?>" width="50%"/>
                                </td>
                                <td><?php echo $des; ?></td>
                                <td>
                                    <button type="button" class="btn editBtn">Update</button>
                                    <a href="<?php echo $url; ?>admin/function/add-delete-carousel/delete-carousel.php?id=<?php echo $id; ?>" class="btn">Delete</a>
                                </td>
                            </tr>
                            <?php
                        }
    ...
    <div id="admin__modal">
        <div class="modal__content">
            <div class="modal__header">
                <h5 class="modal__title">Add Carousel</h5>
                <span class="close">&times;</span>
            </div>
            <form action="./function/add-delete-carousel/add-carousel.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal__title">Edit Carousel</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="./function/add-delete-carousel/update-carousel.php" method="POST" enctype="multipart/form-data">
