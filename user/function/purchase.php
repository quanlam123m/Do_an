...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        if(isset($_POST['order'])) {
            $sql1 = "INSERT INTO `order-manager`(`Fullname`,`User_ID`, `Email`, `Phonenumber`, `Address`, `Status`) 
                    VALUES ('$_POST[fullname]','$_POST[id]', '$_POST[email]','$_POST[phonenumber]','$_POST[address]', 'Processing')";
